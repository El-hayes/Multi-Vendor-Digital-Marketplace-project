...
<head>
    ...
    <!-- Slick -->
    <link rel="stylesheet" href="{{ asset('assets/frontend//css/slick.cs') }}s">
    <!-- magnific popup -->
    ...
    <div class="mobile-menu d-lg-none d-block">
        ...
        <div class="mobile-menu__inner">
            <a href="index.html" class="mobile-menu__logo">
                <img src="assets/frontend//images/logo/logo-two.png" alt="Logo" class="white-version">
            </a>
                ...
                <div class="header-right__inner d-lg-none my-3 gap-1 d-flex flx-align">
                    ...
                    <div class="dropdown">
                        <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <img src="assets/frontend//images/icons/user.svg" alt="">
                        </button>
            ...
            <div class="dashboard-body">
                ...
                <div class="dashboard-footer bottom-footer-two mt-32 border-0 bg-white">
                    <div class="bottom-footer__inner flx-between gap-3">
                        <p class="bottom-footer__text font-14"> Copyright © {{ date('Y') }} DigiMart, All rights
                            reserved.</p>
