        ...
        <div class="row gy-5">
            <div class="col-xl-3 col-sm-6">
                <div class="footer-widget">
                    <div class="footer-widget__logo">
                        <a href="index.html"> <img src="{{ asset('assets/frontend/images/logo/white-logo.png') }}" alt=""></a>
                    </div>
            ...
            <div class="col-xl-4 col-sm-6">
                <div class="footer_widget_count">
                    ...
                    <div class="img">
                        <img src="{{ asset('assets/frontend/images/thumbs/pay_brand.png') }}" alt="Payment" class="img-fluid w-100">
                    </div>
                </div>
            </div>
        </div>
